...
def app():
    ...
    with open('M_single.pickle', 'rb') as f:
...
#    msg = '%s: %f (%f)' % (name, cv_results.mean(), cv_results.std())
    ...
    if selected == '색차 예측':
        ...
        if selected2 =='중방식 도료':
            ...
            color_list = ['AE1066EHE0012','EP174(T)PTA-BLACK', 'EP174(T)PTA-BLUE', 'YE0208V','YE2236G',
                          'YE2303V','YE2304Y','YE2308V','YE2310G','YE2317G', 'YE2322R','YE2326G', 'YE2330B',
                          'YE2335Y' ,'YE2336W','YE2339K', 'YE2347Y', 'YE2391R' ,'YM0407K', 'YM0410G', 'YM0410Y',
                          'YM0422R', 'YM0422Y', 'YM0430R', 'YX0305V', 'YX0314K','YX0315G','YX0328Y' ,'YX0337R' ,
                          'YX0393R','YX0397K','YX0397W']
            ...
            if st.button('Run Prediction'): 
                ...
                st.write(New_x2.style.format("{:.3}"))
                ...
                st.write(predictions.style.format("{:.3}"))
        ...
        if selected2 =='PCM 도료':
            ...
            color_list = ['YE2204Y', 'YE2205V', 'YE2206B', 'YE2209R' ,'YE2210G', 'YE2210K', 'YE2231W' ,'YE2263Y'
                          ,'YE2331W', 'YF3401K', 'YF3401V' ,'YF3404Y','YF3406B','YF3410G', 'YF3410K', 'YF3414Y', 
                          'YF3416Y', 'YF3417G' ,'YF3429W','YF3430B' ,'YF3430R']
        ...
        if selected2 =='일반공업 도료':
            ...
            color_list = ['YE22_10K','YE2210G','YE2326G', 'YE2339K', 'YE2336W', 'YE2347Y','YE3426G', 
                          'YW2698K', 'YX0310G', 'YX1205V' ,'YX1208V', 'YX1210O','YX1214K', 'YX1222W', 
                          'YX1228Y' ,'YX1229Y','YX122W','YY1103G', 'YY1111R' ,'YY1112B','YY1113B',
                          'YY1116', 'YY1116Y', 'YY1120K','YY1130R', 'YY1137W','YY1228Y']
    ...
    if selected == '조색제 예측':
        ...
        if selected3 =='중방식 도료':
            ...
            if st.button('Run Prediction',key = count):
                ...
                para1.columns = ['B_S','Std_L','Std_a','Std_b','Ini_Dl','Ini_Da','Ini_Db']
                ...
                ini_color = ['B_S','Std_L','Std_a','Std_b','Ini_Dl','Ini_Da','Ini_Db']
